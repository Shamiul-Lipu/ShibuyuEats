...
const Header = () => {
  ...
  return (
    <div className="bg-emerald-100">
      <div className="bg-emerald-100 container mx-auto relative flex items-center justify-between  p-3 rounded-lg">
        {/* Logo Section */}
        <Link to="/" className="inline-flex items-center">
          <img className="h-12 w-12 text-blue-500" src={Logo} alt="" />
          <span className="ml-2 text-xl font-bold tracking-wide  bg-emerald-100">
        ...
        <ul className="items-center hidden space-x-8 lg:flex">
          <li>
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "font-bold text-lg tracking-wide text-indigo-600 transition-colors duration-200 hover:text-blue-400"
          ...
          <li>
            {user ? (
              ...
              <NavLink
                to="/login"
                className={({ isActive }) =>
                  isActive ? "btn btn-primary" : "btn btn-outline btn-primary"
                }
              >
